    ...
    <div>
      ...
      <div className="screen-head">
        ...
        <div className="screen-actions">
          ...
          <button className="btn-secondary btn btn-sm">View full dashboard</button>
        </div>
      </div>
      ...
      <div className="grid grid-cols-4 gap-4 mb-6">
        {d.kpis.map(kpi => (
          <KpiCard
            ...
            delta={kpi.target}
            type={
              kpi.status === 'exceeding' ? 'ok'   :
              kpi.status === 'tracking'  ? 'default' : 'default'
            }
          />
        ))}
      </div>
            ...
            <div className="card-head">
              ...
              <div className="flex items-center gap-3 text-xs font-mono text-ink-400">
                {filters.wave === 'All Waves'
                  ...
                  : <span className="text-brand-700 font-semibold">{filters.wave}</span>
                }
              </div>
            </div>
          ...
          <div className="card">
            <div className="card-head">
              ...
              <span className="text-xs font-mono text-ink-400">
                ...
                {(filters.channel !== 'All Channels' || filters.segment !== 'All Segments') && (
            ...
            {variants.length === 0 ? (
              ...
              <div>
                {/* Table head */}
                <div
                  className="grid gap-3 px-5 py-2 bg-ink-50 border-b border-ink-200
                    ...
                    >
                      ...
                      <div>
                        ...
                        <div className="text-xs text-ink-400 mt-0.5">
                          {v.channel} · {v.segment} · Pillar {v.id.includes('IVA') ? 'P1' : 'P2'}
                        </div>
                      </div>
        ...
        <div className="flex-1 space-y-4">
          ...
          <div className="card">
            ...
            <div className="card-body space-y-3">
              ...
              <p className="text-[10px] text-ink-400 pt-2 border-t border-dashed
                           border-ink-200">
                % of segment with ≥1 meaningful engagement · Day 1–{d.dayInFlight}
              </p>
            </div>
          </div>
          ...
          >
            ...
            <p className="text-sm text-ink-700 leading-relaxed mb-2">
              CTR declined from{' '}
              <strong>{d.fatigueSignal.ctrStart}%</strong> in Week 1
              to{' '}
