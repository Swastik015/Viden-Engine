import { Search, FileText, Layers, PlayCircle, ArrowRight } from 'lucide-react'
...
const PHASE_CARDS = [
  ...
  },
  {
    ...
    color:       { bg: '#F0FDF4', border: '#BBF7D0', icon: '#166534', btn: '#166534' },
  },
  {
    id:          'activate',
    icon:        PlayCircle,
          ...
          return (
            ...
            >
              ...
              <div
                ...
                style={{
                  background: phase.color.bg,
                  border: `1px solid ${phase.color.border}`,
                }}
              >
                <Icon size={20} style={{ color: phase.color.icon }} strokeWidth={1.8} />
              </div>
